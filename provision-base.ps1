...
$backgroundPath = 'C:\Windows\Web\Wallpaper\Windows\wireguard.png'
$logo = [System.Drawing.Image]::FromFile((Resolve-Path 'wireguard.png'))
...
New-Item -Path HKLM:Software\Policies\Microsoft\Windows\Personalization -Force `
    | New-ItemProperty -Name LockScreenImage -Value C:\Windows\Web\Screen\wireguard.png `
...
# allow inbound ICMPv4 Echo Request (aka ping).
New-NetFirewallRule `
    -Name 'ICMPv4-Echo-Request-In-ICMP' `
    -DisplayName 'ICMPv4 Echo Request (ICMP-In)' `
    -Direction Inbound `
    -Enabled True `
    -Protocol ICMPv4 `
    -IcmpType 8 `
